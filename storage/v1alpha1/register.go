...
var (
	...
	DatabaseRestoreKind             = reflect.TypeOf(DatabaseRestore{}).Name()
	DatabaseRestoreGroupKind        = schema.GroupKind{Group: Group, Kind: DatabaseRestoreKind}.String()
	DatabaseRestoreKindAPIVersion   = DatabaseRestoreKind + "." + SchemeGroupVersion.String()
	DatabaseRestoreGroupVersionKind = SchemeGroupVersion.WithKind(DatabaseRestoreKind)
