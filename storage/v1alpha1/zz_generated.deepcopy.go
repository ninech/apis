...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisMemorySize) DeepCopyInto(out *RedisMemorySize) {
	*out = *in
	out.Quantity = in.Quantity.DeepCopy()
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisMemorySize.
func (in *RedisMemorySize) DeepCopy() *RedisMemorySize {
	if in == nil {
		return nil
	}
	out := new(RedisMemorySize)
	in.DeepCopyInto(out)
	return out
}
