...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeResurrector) DeepCopyInto(out *NodeResurrector) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeResurrector.
func (in *NodeResurrector) DeepCopy() *NodeResurrector {
	if in == nil {
		return nil
	}
	out := new(NodeResurrector)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NodeResurrector) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeResurrectorList) DeepCopyInto(out *NodeResurrectorList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NodeResurrector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeResurrectorList.
func (in *NodeResurrectorList) DeepCopy() *NodeResurrectorList {
	if in == nil {
		return nil
	}
	out := new(NodeResurrectorList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NodeResurrectorList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeResurrectorObservation) DeepCopyInto(out *NodeResurrectorObservation) {
	*out = *in
	in.ChildResourceStatus.DeepCopyInto(&out.ChildResourceStatus)
	in.ReferenceStatus.DeepCopyInto(&out.ReferenceStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeResurrectorObservation.
func (in *NodeResurrectorObservation) DeepCopy() *NodeResurrectorObservation {
	if in == nil {
		return nil
	}
	out := new(NodeResurrectorObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeResurrectorParameters) DeepCopyInto(out *NodeResurrectorParameters) {
	*out = *in
	out.Cluster = in.Cluster
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeResurrectorParameters.
func (in *NodeResurrectorParameters) DeepCopy() *NodeResurrectorParameters {
	if in == nil {
		return nil
	}
	out := new(NodeResurrectorParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeResurrectorSpec) DeepCopyInto(out *NodeResurrectorSpec) {
	*out = *in
	in.ResourceSpec.DeepCopyInto(&out.ResourceSpec)
	out.ForProvider = in.ForProvider
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeResurrectorSpec.
func (in *NodeResurrectorSpec) DeepCopy() *NodeResurrectorSpec {
	if in == nil {
		return nil
	}
	out := new(NodeResurrectorSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeResurrectorStatus) DeepCopyInto(out *NodeResurrectorStatus) {
	*out = *in
	in.ResourceStatus.DeepCopyInto(&out.ResourceStatus)
	in.AtProvider.DeepCopyInto(&out.AtProvider)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeResurrectorStatus.
func (in *NodeResurrectorStatus) DeepCopy() *NodeResurrectorStatus {
	if in == nil {
		return nil
	}
	out := new(NodeResurrectorStatus)
	in.DeepCopyInto(out)
	return out
}
