...
func (in *AuditLogConfiguration) DeepCopyInto(out *AuditLogConfiguration) {
	*out = *in
	if in.Targets != nil {
		...
		*out = make([]AuditLogTarget, len(*in))
		copy(*out, *in)
	}
}
...
func (in *KubernetesClusterParameters) DeepCopyInto(out *KubernetesClusterParameters) {
	*out = *in
	...
	if in.VerticalPodAutoscalerRecommendOnly != nil {
		in, out := &in.VerticalPodAutoscalerRecommendOnly, &out.VerticalPodAutoscalerRecommendOnly
		*out = new(bool)
		**out = **in
	}
}
...
func (in *NKEClusterSettings) DeepCopyInto(out *NKEClusterSettings) {
	*out = *in
	...
	if in.ContainerRegistries != nil {
		...
		*out = make([]metav1alpha1.TypedReference, len(*in))
		copy(*out, *in)
	}
}
