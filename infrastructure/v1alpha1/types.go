...
const (
	...
	Ubuntu26_04 OperatingSystem = "ubuntu26.04"
...
type VClusterSettings struct {
	...
	// cluster, e.g. "1.34". The patch version cannot be specified and the
	// latest supported one will be used.
	// +optional
	// +kubebuilder:default:="1.33"
	// +kubebuilder:validation:Enum:="1.26";"1.27";"1.28";"1.29";"1.30";"1.31";"1.32";"1.33";"1.34"
