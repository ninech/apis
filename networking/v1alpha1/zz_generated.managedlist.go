...
// GetItems of this IngressHAProxyList.
func (l *IngressHAProxyList) GetItems() []resource.Managed {
...
// GetItems of this IngressNginxList.
func (l *IngressNginxList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
